...
def parse_args():
    ...
    parser.add_argument('--param-name', type=str, nargs='+',
                        default=['roi_heads.box_predictor.cls_score',
                                 ...
                                 'roi_heads.box_predictor_bow.cls_score',
                                 'roi_heads.box_predictor_bow.bbox_pred',],
...
def surgery_loop(args, surgery):
    ...
    if 'roi_heads.box_predictor_bow.cls_score' in args.param_name:
        tar_sizes.append(TAR_SIZE + 1)
    if 'roi_heads.box_predictor_bow.bbox_pred' in args.param_name:
        tar_sizes.append(TAR_SIZE * 4)
