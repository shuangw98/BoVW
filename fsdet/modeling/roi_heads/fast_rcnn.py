...
class FastRCNNOutputs(object):
    ...
    def __init__(
        self, box2box_transform, pred_class_logits, pred_proposal_deltas, proposals, smooth_l1_beta,pred_class_logits_aug=None,
    ):
        """
        Args:
        ...
        self.pred_class_logits_aug = pred_class_logits_aug
    ...
    def predict_probs(self):
        ...
        if self.pred_class_logits_aug is not None:
            probs_aug = F.softmax(self.pred_class_logits_aug, dim=-1)
            probs_combine = probs * 0.5 + probs_aug * 0.5
            return probs_combine.split(self.num_preds_per_image, dim=0)
