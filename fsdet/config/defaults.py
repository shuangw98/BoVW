...
# 单看 all_gather 没有 process group�?这里设置�?True 进行单卡 debug
...
_C.MODEL.RESNET_BOVW = ""
_C.MODEL.BOVW_WEIGHT = ""
_C.MODEL.NUM_WORDS = 256
_C.MODEL.ROI_HEADS.CLS_WEIGHT = 1.0
_C.MODEL.ROI_HEADS.BOW_WEIGHT = 1.0
_C.MODEL.ROI_HEADS.AUG_CLS_WEIGHT = 1.0
_C.MODEL.ROI_HEADS.BOW_IOU_THRESHOLD = 0.6
